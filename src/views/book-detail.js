...
function goodreadsUnavailableCard() {
  return '<div class="rating-card rating-public rating-empty-card"><img src="./assets/goodreads.svg" alt="Goodreads logo"><span class="rating-copy"><strong>Goodreads</strong><span>Rating unavailable</span></span></div>';
}
...
export function bookDetailView(state) {
  ...
  const book = detail.book;
  const goodreads = selectGoodreadsRating(detail.ratings);
