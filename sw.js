const SHELL='librariangpt-shell-v19';
const COVERS='librariangpt-covers-v1';
const ASSETS=['./','./index.html','./styles.css?v=19','./ui-v3.css?v=19','./chapter.css?v=19','./perf-v14.css?v=19','./book-admin-v15.css?v=19','./up-next-v16.css?v=19','./data-cache.js?v=19','./app.js?v=19','./perf-v14.js?v=19','./cache-hooks.js?v=19','./ui-v3.js?v=19','./chapter-addon.js?v=19','./book-admin-v15.js?v=19','./up-next-v16.js?v=19','./refresh-data-v19.js?v=19','./supabase-config.js','./manifest.webmanifest?v=19','./icons/icon-192.png','./icons/icon-512.png','./assets/goodreads.svg','./assets/google-books.svg','./assets/open-library.svg'];
