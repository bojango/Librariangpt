const SHELL='librariangpt-shell-v20';
const COVERS='librariangpt-covers-v1';
const ASSETS=['./','./index.html','./styles.css?v=20','./ui-v3.css?v=20','./chapter.css?v=20','./perf-v14.css?v=20','./book-admin-v15.css?v=20','./up-next-v16.css?v=20','./edition-browser-v20.css?v=20','./data-cache.js?v=20','./app.js?v=20','./perf-v14.js?v=20','./cache-hooks.js?v=20','./ui-v3.js?v=20','./chapter-addon.js?v=20','./book-admin-v15.js?v=20','./up-next-v16.js?v=20','./refresh-data-v19.js?v=20','./edition-browser-v20.js?v=20','./supabase-config.js','./manifest.webmanifest?v=20','./icons/icon-192.png','./icons/icon-512.png','./assets/goodreads.svg','./assets/google-books.svg','./assets/open-library.svg'];
