const SHELL='librariangpt-shell-v18';
const COVERS='librariangpt-covers-v1';
const ASSETS=['./','./index.html','./styles.css?v=18','./ui-v3.css?v=18','./chapter.css?v=18','./perf-v14.css?v=18','./book-admin-v15.css?v=18','./up-next-v16.css?v=18','./data-cache.js?v=18','./app.js?v=18','./perf-v14.js?v=18','./cache-hooks.js?v=18','./ui-v3.js?v=18','./chapter-addon.js?v=18','./book-admin-v15.js?v=18','./up-next-v16.js?v=18','./supabase-config.js','./manifest.webmanifest?v=18','./icons/icon-192.png','./icons/icon-512.png','./assets/goodreads.svg','./assets/google-books.svg','./assets/open-library.svg'];
